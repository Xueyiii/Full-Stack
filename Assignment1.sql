...
--5.Write a query that retrieves the columns ProductID, Name, Color and ListPrice from the Production.Product table, the rows that are not NULL
...
--11. Write a query that retrieves the columns Name and ListPrice from the Production.Product table. Your result set should look something like the following. 
SELECt Name, ListPrice
FROM Production.Product
WHERE Name LIKE 'S%'
ORDER BY 1,2

--12.Write a query that retrieves the columns Name and ListPrice from the Production.
SELECt Name, ListPrice
FROM Production.Product
